                ...
                <div className="max-w-6xl mx-auto text-center">
                    ...
                    <div className="grid gap-8 md:grid-cols-3">
                        {plans.map((plan, idx) => (
                            <motion.div
                                key={idx}
                                className={`border rounded-xl p-6 text-left shadow-sm transition-all hover:shadow-lg hover:scale-105 ${plan.highlight
                            ...
                            >
                                ...
                                {/* Button */}
                                <button
                                    className={`mt-4 italic px-4 py-2 rounded border-2 ${plan.highlight
